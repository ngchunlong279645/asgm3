...
public class Event extends JFrame {
	...
	public Event() {
		...
		txtrAbove.setText("----------------------------------------------------------\r\n*  Above 2 tickets will get 10% discount                                            \r\n----------------------------------------------------------");
	...
	public Event(String q,String disc) {
		setTitle("Home");
		...
		JTextArea txtrAbove = new JTextArea();
		txtrAbove.setText("----------------------------------------------------------\r\n*  Above "+q+" tickets price will get "+disc+"% discount                                                    \r\n----------------------------------------------------------");
		txtrAbove.setFont(new Font("Tekton Pro Ext", Font.PLAIN, 15));
		txtrAbove.setBackground(new Color(240, 230, 140));
		txtrAbove.setBounds(10, 35, 405, 73);
		panel_2.add(txtrAbove);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EventRegistration frame = new EventRegistration(q, disc);
				frame.setVisible(true);
	...
	public Event(Object t) {
		...
		table = new JTable();
		table.setModel((TableModel) t);
		
	        p1 = String.valueOf( table.getValueAt(0, 4));
	        p2 = String.valueOf( table.getValueAt(1, 4));
	        p3 = String.valueOf( table.getValueAt(2, 4));
	        p4 = String.valueOf( table.getValueAt(3, 4));
	        eventName4=String.valueOf( table.getValueAt(3, 0));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EventRegistration frame = new EventRegistration (p1,p2,p3,p4,eventName4);
				frame.setVisible(true);
